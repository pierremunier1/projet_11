...
return null},lg=!1;if(L.querySelectorAll)try{var mg=L.querySelectorAll(":root");mg&&1==mg.length&&mg[0]==L.documentElement&&(lg=!0)}catch(a){}var ig=lg;var Qd={},R=null,Ag=Math.random();Qd.C="GTM-5WM9PV";Qd.$b="990";Qd.gi="";var Bg={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Cg={__paused:!0,__tg:!0},Dg;for(Dg in Bg)Bg.hasOwnProperty(Dg)&&(Cg[Dg]=!0);var Eg="www.googletagmanager.com/gtm.js";
var Fg=Eg,Gg=null,Hg=null,Ig="//www.googletagmanager.com/a?id="+Qd.C+"&cv=253",Jg={},Kg={},Lg=function(){var a=R.sequence||1;R.sequence=a+1;return a};
...
var X=function(sa){return mp("transaction"+sa,1)},S=X("Id");D("ecommerce:addTransaction",{id:S,affiliation:X("Affiliation"),revenue:X("Total"),shipping:X("Shipping"),tax:X("Tax")});for(var O=X("Products")||[],oa=0;oa<O.length;oa++){var xa=O[oa];D("ecommerce:addItem",{id:S,sku:xa.sku,name:xa.name,category:xa.category,price:xa.price,quantity:xa.quantity})}D("ecommerce:send");}else if("TRACK_TIMING"==m.vtp_trackType){}else if("DECORATE_LINK"==m.vtp_trackType){}else if("DECORATE_FORM"==m.vtp_trackType){}else if("TRACK_DATA"==m.vtp_trackType){}else{m.vtp_enableEcommerce&&(D("require","ec","ec.js"),Q());if(m.vtp_doubleClick||"DISPLAY_FEATURES"==m.vtp_advertisingFeaturesType){var za="_dc_gtm_"+String(m.vtp_trackingId).replace(/[^A-Za-z0-9-]/g,
...
c.vtp_gtmOnFailure()},c.vtp_gtmOnFailure));var v=W("dataLayer"),w=v&&v.hide;w&&(w.end||!0===w["GTM-5WM9PV"])&&(w[c.vtp_optimizeContainerId]=!0)}else M(c.vtp_gtmOnFailure)};Z.__opt=b;Z.__opt.g="opt";Z.__opt.h=!0;Z.__opt.priorityOverride=0}();
